...
cout<<"El tripulante con nombre: "<<this->getNombre()<<" fecha de nacimiento: "<<this->getFechaNacimiento()<<" direccion: "<<this->getDireccion()<<" id: "<<this->getID()<<" y email: "<< this->getPuesto()<<endl;
