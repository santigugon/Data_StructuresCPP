...
using namespace std;
    ...
    std::cout << "Porcentaje de puntualidad: " << porcentajePuntualidad << "%" << std::endl;
    std::cout << "Número de estrellas: " << numEstrellas << std::endl;
    std::cout << "Temperatura promedio: " << temperaturaPromedio << std::endl;
    std::cout << "Alimentación a bordo: " << (alimentacion ? "Sí" : "No") << std::endl;
};
